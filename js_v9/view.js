...
function drawScoreboard() {
    ...
    if (gameState === 0) {
        ...
        renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 170 * settings.scale, 150, "#2c3e50", "六角转盘");
...
function showText(text) {
    ...
    if (text == 'gameover') {
        ...
        if (settings.platform == 'mobile') {
            restartText = '触动任何地方重新开始!';
        } else {
            restartText = '按回车键 (或点击任何地方) 重新开始!';
        }
